...
import os
import openai
openai.api_key = "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"
...
with open("part12.txt", "r", encoding="UTF-8") as f:
    a = f.readlines()
for x in a:
    i = len(x)
    x = x[0:i - 1]
...
for zzc in range(0,len(nickname)):
    ...
    suffix_one="question:From the above text, Which of the following options do you infer "+nickname[zzc]+" is referring to?"  #Angry Creamsicle
