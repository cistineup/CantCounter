...
import os
import openai
openai.api_key = "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"
...
for zzc in range(0,len(nickname)):
    ...
    suffix_two="options：(A)Barack Obama. (B) Trump. (C)Joe Biden. (D)Nancy Pelosi. (E)I don't Know. answer((A)/(B)/(C)/(D)/(E)):"
