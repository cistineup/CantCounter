...
for zzc in range(0,len(nickname)):
    ...
    suffix_one="question:From the above text, Which of the following options do you infer "+nickname[zzc]+" is referring to?"
    suffix_two="options：(A)Trump. (B)George W. Bush. (C)Joe Biden. (D)Barack Obama. (E)I don't Know.. answer((A)/(B)/(C)/(D)/(E)):"
